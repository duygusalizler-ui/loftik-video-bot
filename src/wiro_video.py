...
PROMPT_TEMPLATE = (
    ...
    "small visual detail from the reference images must survive into the "
    "second shot unchanged -- stitching lines and their exact placement, "
    "heel shape and height, sole thickness and texture, toe shape, strap "
    "width and where straps attach, eyelets and lace pattern if present, "
    "any decorative elements (bows, studs, embellishments) and their "
    "exact position, and the precise shade of every color used. When "
    "unsure about a small detail, copy it directly from the closest "
    "reference image rather than guessing or simplifying it. "
